...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2020 at 10:33 AM
...
(1045, 4, 'Robbers Cave', 'Robbers cave is a river cave formed in the Himalayas about 8 kilometres from Dehradun in the north-eastern state of Uttarakhand. This river cave is very close to Sahasradhara which are the thousandfold springs in Uttarakhand. It is mostly frequented by tourists seeking the adventure of witnessing this natural formation that has river water flowing from the middle of a cave.', '0.00'),
(1051, 5, 'Red Fort', 'The most famous monument of Delhi, the Red Fort, stands not only as a powerful reminder of the Mughal era India but also a symbol struggle for freedom of India. It was build by fifth Mughal emperor Shah Jahan, when he decided to shift his capital there from Agra in 1638.', '30.00'),
(1052, 5, 'Akshardham', 'A relatively new attraction, this massive temple complex was built by the BAPS Swaminarayan Sanstha spiritual organization and opened in 2005. It is dedicated to showcasing Indian culture. As well as the astonishing architecture of the pink stone and white marble shrine, the complex includes sprawling garden, sculptures, and boat ride.', '0.00'),
(1053, 5, 'Humayuns Tomb', 'If you think Humayuns Tomb looks a bit like the Taj Mahal in Agra, that is because it was the inspiration for the Taj Mahals creation. The tomb was built in 1570, and houses the body of the second Mughal emperor, Humayun. It was the first of this type of Mughal architecture to be built in India, and the Mughal rulers followed it up with an extensive period of construction all over the country.', '30.00'),
(1054, 5, 'India Gate', 'The towering archway of India Gate at the center of New Delhi is a war memorial, built in memory of the Indian soldiers who lost their lives fighting for the British Army in World War I. At night it glows warmly under floodlights, and the gardens that line its boulevard are a popular place to enjoy a warm summer evening.', '0.00'),
(1055, 5, 'Lotus Temple', 'The Bahai Temple is commonly called the Lotus Temple, as it is shaped like a lotus flower. It is particularly pretty at night, when it is attractively lit up. Made out of concrete covered in white marble, the temple belongs to the Bahai Faith, which proclaims the unity of all people and religions.', '0.00'),
(1061, 6, 'Anjuna Beach', 'Anjuna Beach was once home to the hippies. They have now moved on but their legacy remains. The Wednesday Anjuna Beach flea market is bigger than ever and continues to remain popular. Curlies plays a lot more chill-out music than psychedelic trance these days though. Anjuna is an ideal area for backpackers and budget travelers.', '0.00'),
(1062, 6, 'Dudhsagar Falls', 'Dudhsagar Falls is a four-tiered waterfall located on the Mandovi River in the Indian state of Goa. It is amongst Indias tallest waterfalls with a height of 310 m (1017 feet) and an average width of 30 metres (100 feet).', '50.00'),
...
(10102, 10, 'Gateway of India', 'The most recognized monument of Mumbai, the Gateway of India, was constructed in 1924 to commemorate the visit of King George V and Queen Mary to the city. It is also where the last of the British troops departed, marking the end of British rule when India gained Independence in 1947. The looming Gateway is designed to be the first thing that visitors see when approaching Mumbai by boat. It is a popular place to start exploring Mumbai.', '0.00'),
